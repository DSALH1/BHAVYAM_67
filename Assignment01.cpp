...
int main() {
    ...
    cout<<"Height of tree using Recursion="<<ht-1<<endl;
    ht=b.heightIter(b.root);
    cout<<"Height of tree using Iterative="<<ht-1<<endl;

    //copying a tree
    cout<<endl<<endl;
    cout<<"Copying a tree:\n";
    node*copy=b.copyTree(b.root);
    node*copy2=b.copyTreeIter(b.root);
    cout<<"Address of original root="<<b.root<<endl;
    cout<<"Address of first copied root="<<copy<<endl;
    cout<<"Address of second copied node="<<copy2<<endl;

    //counting leaf and internal nodes
    cout<<endl<<endl;
    cout<<"Number of leaf nodes recursive="<<b.leafNodes(b.root);
    cout<<"Number of leaf nodes Iterative="<<b.leafNodesIter(b.root);
    cout<<"Number of internal nodes="<<b.internalNodes(b.root);

    //Deleting nodes
    cout<<endl<<endl;
    cout<<"Deleting nodes by recursive:\n";
    b.deleteNodes(b.root);
    cout<<"Deleting nodes by iterative:\n";
    b.deleteNodesIter(copy);
    return 0;
}
